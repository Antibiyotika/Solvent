...
/// <summary>
/// One file within a <see cref="DuplicateFileGroup"/>. Plain mutable
/// property (not INotifyPropertyChanged) is enough here — the UI's
/// CheckBox writes IsSelected via a normal two-way binding, and the
/// Cleanup page only ever reads it back after the user clicks Delete,
/// not while the checkbox is being toggled.
/// </summary>
...
public sealed class StartupItem
{
    ...
    public StartupSignatureStatus SignatureStatus { get; set; } = StartupSignatureStatus.Unknown;
